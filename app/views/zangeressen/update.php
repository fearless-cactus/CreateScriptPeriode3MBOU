...
<div class="container">
    ...
    <div class="row mt-3 d-flex justify-content-center">
        <div class="col-6">
            <form action="<?= URLROOT; ?>/ZangeressenController/update" method="post" novalidate>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input name="nationaliteit" type="text" class="form-control" id="nationaliteit" value="<?= $_POST['nationaliteit'] ?? $data['zangeres']->Nationaliteit ?? ''; ?>" required>
                </div>
                <div class="mb-3">
                    <label for="nettowaarde" class="form-label">Nettowaarde</label>
                    <input name="nettowaarde" type="number" min="0" max="999999999" step="0.01" class="form-control" id="nettowaarde" value="<?= $_POST['nettowaarde'] ?? $data['zangeres']->Nettowaarde ?? ''; ?>" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input name="bekendstehit" type="text" class="form-control" id="bekendstehit" value="<?= $_POST['bekendstehit'] ?? $data['zangeres']->BekendsteHit ?? ''; ?>" required>
                </div>
